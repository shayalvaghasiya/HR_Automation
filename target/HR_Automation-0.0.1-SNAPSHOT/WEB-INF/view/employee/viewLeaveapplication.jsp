    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Leave Request table</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <c:forEach items="${leaveapplicationList}"  var="i" varStatus="j">
                        <tr>
                            <td>${j.count}</td>
                            <td>${i.leaveVO.leaveType}</td>
                            <td>${i.fromDate}</td>
                            <td>${i.toDate}</td>
                            <td>${i.leaveStatus}</td>
                            <td>
                            <!-- editLeaveapplication.html?leaveapplicationId=${i.id} -->
                              <button class="btn btn-outline-primary"><a href="editLeaveapplication.html?leaveapplicationId=${i.id}">EDIT</a></button>
                            </td>
                            <td>
                            <!-- deleteLeaveapplication.html?leaveapplicationId=${i.id} -->
                              <button class="btn btn-outline-primary"><a href="deleteLeaveapplication.html?leaveapplicationId=${i.id}">REMOVE</a></button>
                            </td>
                            </c:forEach>
                        </tr>
