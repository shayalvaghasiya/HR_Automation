    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Allowance and Deduction  table</h4>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <c:forEach items="${allowanceList}" var="i" varStatus="j">
                      	  <tr>
                        		 <td>${j.count}</td>
                           		 <td>${i.designationVO.designationName}</td>
                           		 <td>${i.allowORded}</td>
                            	 <td>${i.allowance_dedType}</td>
                            	 <td>${i.allowance_dedLimit}</td>
                            	 <td>${i.allowance_dedDescription}</td>
                            	 <td>
                      
                       
                              <button class="btn btn-outline-primary"><a href="editAllowance.html?allowanceId=${i.id}">EDIT</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="deleteAllowance.html?allowanceId=${i.id}">REMOVE</a></button>
                            </td>
                        </tr>
                        </c:forEach>
                            </tbody>
