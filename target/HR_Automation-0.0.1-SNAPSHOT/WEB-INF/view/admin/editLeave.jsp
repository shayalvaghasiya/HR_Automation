            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post" action="updateLeave.html" modelAttribute="leaveVO">
                    <f:hidden path="id"/>
                    <fieldset>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <f:input id="days" class="form-control" path="leaveDays" minlength="2" type="text" />
                      </div>
