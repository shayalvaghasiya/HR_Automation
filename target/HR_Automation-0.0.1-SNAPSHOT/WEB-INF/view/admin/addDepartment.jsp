            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="get" action="insertDepartment.html" modelAttribute="DepartmentVO">
                    <fieldset>
                      <div class="form-group">
                        <label for="dept"><i style="color: #fb9678 !important">* </i>Department Name </label>
                        <input id="dept" class="form-control" name="departmentName" minlength="2" type="text" required>
                      </div>
                      
                      <div class="form-group">
                        <label for="detail"><i style="color: #fb9678 !important">* </i>Description </label>
                        <textarea rows="5" cols="60" class="form-control" name="departmentDescription" required></textarea>
                      </div>
