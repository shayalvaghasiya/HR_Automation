            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="get" action="insertDesignation.html" modelAttribute="DesignationVO">
                    <fieldset>
                      <div class="form-group">
                        <label for="desg"><i style="color: #fb9678 !important">* </i>Designation </label>
                        <input id="desg" class="form-control" name="designationName" minlength="2" type="text" required>
                      </div>
                      
                      <div class="form-group">
                        <label for="detail"><i style="color: #fb9678 !important">* </i>Description </label>
                        <textarea rows="5" cols="60" class="form-control" name="designationDescription" required></textarea>
                      </div>
