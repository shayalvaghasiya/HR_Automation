    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Letter Type table</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <c:forEach items="${letterTypeList}" var="i" varStatus="j">
                        <tr>
                            <td>${j.count}</td>
                           		 <td>${i.letterTypeName}</td>
                            	 <td>${i.letterTypeDescription}</td>
                            <td>
                              <button class="btn btn-outline-primary">
                              	<a href="<%=request.getContextPath()%>/documents/letters/${i.letterTypeFileName}" target="blank">View</a>
                              </button>
                            </td>
                            
                            <td>
                              <button class="btn btn-outline-primary"><a href="editLetterType.html?letterTypeId=${i.id}">EDIT</a></button>
                            </td>
                            
                            <td>
                              <button class="btn btn-outline-primary"><a href="deleteLetterType.html?letterTypeId=${i.id}">REMOVE</a></button>
                            </td>
