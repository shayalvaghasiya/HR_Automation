                      ...
                      <tbody>
                       <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        ...
                        <tr>
                            ...
                            <td>${i.employeeContact}</td>
                            <td>${i.employeeAddress}</td>
                            <td>${i.employeeDateofBirth}</td>
                            <td>${i.employeeBloodGroup}</td>
                            <td>${i.employeeMaritalStatus}</td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="editEmployee.html?employeeId=${i.id}">EDIT</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="deleteEmployee.html?employeeId=${i.id}">REMOVE</a></button>
                            </td>
                        </tr>
                        </c:forEach>
                                     </tbody>
