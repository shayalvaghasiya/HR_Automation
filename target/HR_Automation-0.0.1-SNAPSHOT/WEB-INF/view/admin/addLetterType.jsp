            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post"  action="insertLetterType.html" modelAttribute="LettertTypeVO" enctype="multipart/form-data">
                    <fieldset>
                      <div class="form-group">
                        <label for="letter"><i style="color: #fb9678 !important">* </i>Letter Type</label>
                        <input id="letter" class="form-control" name="letterTypeName" minlength="2" type="text" required>
                      </div>
                      <div class="form-group">
                        <label for="details"><i style="color: #fb9678 !important">* </i>Description </label>
                        <textarea rows="5" cols="60" class="form-control" name="letterTypeDescription" required></textarea>
                      </div>
                      ...
                      <label for="lett"><i style="color: #fb9678 !important">* </i>Upload File </label>
                        ...
                        <input id="lett" class="form-control" name="letterTypeFileToUpload"  type="file" required>
                      </div>
