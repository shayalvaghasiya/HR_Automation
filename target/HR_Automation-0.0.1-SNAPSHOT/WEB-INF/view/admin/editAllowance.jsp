        ...
        <div class="content-wrapper">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Allowance/Deduction</h4>
                  
                  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                  
                  <f:form class="cmxform" id="commentForm" method="post"  modelAttribute="AllowanceVO" action="updateAllowance.html">
                    <f:hidden path="id"/>
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <label for="basicsal"><i style="color: #fb9678 !important">* </i>Basic Salary</label>
                        <f:input id="basicsalary" class="form-control" path="salaryBasicSalary" minlength="2" type="text" readonly="readonly"/>
                   
                      </div>
                   
                    
                      <div class="form-group">
                        <label for="status"><i style="color: #fb9678 !important">* </i>Select </label>
                        <f:radiobutton path="allowORded" value="allowance" />Allowance
                        <f:radiobutton path="allowORded" value="deduction" />Deduction
                      </div>
                    
                    
                      <div class="form-group">
                        <label for="type"><i style="color: #fb9678 !important">* </i> Type</label>
                        <f:input id="type" class="form-control" path="allowance_dedType" minlength="2" type="text" />
                      </div>
                      <div class="form-group">
                        <label for="limit"><i style="color: #fb9678 !important">* </i> Limit (%) </label>
                        <f:input id="limit" class="form-control" type="number" path="allowance_dedLimit" />
                      </div>
                      <div class="form-group">
                        <label for="desc"><i style="color: #fb9678 !important">* </i>Description </label>
                        <f:textarea rows="5" cols="60" class="form-control" path="allowance_dedDescription" />
                      </div>                      
