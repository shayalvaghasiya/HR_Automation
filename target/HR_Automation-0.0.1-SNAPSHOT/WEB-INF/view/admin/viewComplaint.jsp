                        ...
                        <tr>
                            ...
                            <td>
                              <button class="btn btn-outline-primary">
                              	<a href="<%=request.getContextPath()%>/documents/complaints/${i.complaintFileName}" target="blank">View</a>
                              </button>
                            </td>
                            
                           
                            <td>
                            	<c:if test="${i.complaintSatus eq 'pending'}">
                              		<button class="btn btn-outline-primary"><a href="replyComplaint.html?complaintId=${i.id}">REPLY</a></button>
                           		</c:if>
                           		<c:if test="${i.complaintSatus ne 'pending'}">
									RESOLVED
                           		</c:if>
                            </td> 
                        </tr>
