            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post" modelAttribute="AttendanceVO" action="insertAttendance" enctype="multipart/form-data">
                    <fieldset>
                    <div class="form-group">
                        <label for="month"><i style="color: #fb9678 !important">* </i>Month</label>
                        <select id="month" class="form-control" name="attendanceFileMonth" required>
                      ...
                      <div class="form-group">
                      <label for="att"><i style="color: #fb9678 !important">* </i>Upload File </label>
                        <i style="color: #fb9678 !important">* </i>
                        <input id="attendance" class="form-control" name="AttendanceFileToUpload"  type="file"/>
                      </div>
