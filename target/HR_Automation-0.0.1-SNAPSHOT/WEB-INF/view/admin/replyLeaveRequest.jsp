    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Reply Leave Request</h4>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <c:forEach items="${leaveapplicationList}"  var="i" varStatus="j">
                        <tr>
                            ...
                            <td>${i.toDate}</td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="sendReplyLeaveapplication.html?leaveapplicationId=${i.id}&leaveStatus=approved">Approved</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="sendReplyLeaveapplication.html?leaveapplicationId=${i.id}&leaveStatus=deny">Deny</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="#">Keep Pending</a></button>
                            </td>
                            </c:forEach>
                        </tr>
