                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <c:forEach items="${designationList}"  var="i" varStatus="j">
                        <tr>
                            <td>${j.count}</td>
                            <td>${i.designationName}</td>
                            <td>${i.designationDescription}</td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="editDesignation.html?designationId=${i.id}">EDIT</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="deleteDesignation.html?designationId=${i.id}">REMOVE</a></button>
                            </td>
                            </c:forEach>
                        </tr>
