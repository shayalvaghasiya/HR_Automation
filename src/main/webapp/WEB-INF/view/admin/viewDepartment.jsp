                      ...
                      <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <c:forEach items="${departmentList}" var="i" varStatus="j">
                      	  <tr>
                            	 ...
                            	 <td>
                              			<button class="btn btn-outline-primary"><a href="editDepartment.html?departmentId=${i.id}">EDIT</a></button>
                            	</td>
                            	<td>
                              		<button class="btn btn-outline-primary"><a href="deleteDepartment.html?departmentId=${i.id}">REMOVE</a></button>
                            	</td>
                        </tr>
                        </c:forEach>
                      </tbody>
