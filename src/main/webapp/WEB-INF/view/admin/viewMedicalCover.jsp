    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Medical Cover table</h4>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <c:forEach items="${medicalcoverList}" var="i" varStatus="j">
                      	  <tr>
                        		 <td>${j.count}</td>
                           		 <td>${i.designationVO.designationName}</td>
                            	 <td>${i.medicalcoverAmount}</td>
                            	 <td>
                      
                       
                              <button class="btn btn-outline-primary"><a href="editMedicalCover.html?medicalcoverId=${i.id}">EDIT</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="deleteMedicalCover.html?medicalcoverId=${i.id}">REMOVE</a></button>
                            </td>
                        </tr>
                        </c:forEach>
                            </tbody>
