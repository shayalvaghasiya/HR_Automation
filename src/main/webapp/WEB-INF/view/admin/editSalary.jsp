            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post"  modelAttribute="SalaryVO" action="updateSalary.html">
                   <f:hidden path="id"/>
                    <fieldset>
                      ...
                      <div class="form-group">
                        <label for="basic"><i style="color: #fb9678 !important">* </i>Basic Salary</label>
                        <f:input id="basic" class="form-control" type="number" path="salaryBasicSalary"/>
                      </div>
