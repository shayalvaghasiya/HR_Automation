        ...
        <div class="content-wrapper">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Letter</h4>
                  
                  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <f:form class="cmxform" id="commentForm" method="post"  action="updateLetterType" modelAttribute="LetterTypeVO" enctype="multipart/form-data">
                    
                     <f:hidden path="id"/>
                    <fieldset>
                      <div class="form-group">
                        <label for="letter"><i style="color: #fb9678 !important">* </i>Letter</label>
                        <f:input path="letterTypeName" class="form-control"/>
      <%--                   <f:input id="letter" class="form-control" path=""  name="letterTypeName" minlength="2" /> --%>
                      </div>
                      
                      <div class="form-group">
                        <label for="details"><i style="color: #fb9678 !important">* </i>Description </label>
                        <f:textarea rows="5" cols="60" class="form-control" path="letterTypeDescription"/>
                      </div>
                      
                                            
                      <div class="form-group">
                      <label for="lett"><i style="color: #fb9678 !important">* </i>Upload File </label>
                        <i style="color: #fb9678 !important">* </i>
                        <input id="lett" class="form-control" name="letterTypeFileToUpload"  type="file" />
                      </div>
