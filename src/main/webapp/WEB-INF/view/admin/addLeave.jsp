            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post" action="insertLeave.html" modelAttribute="LeaveVO">
                    <fieldset>
                     <div class="form-group">
                        <label for="type"><i style="color: #fb9678 !important">* </i>Leave Type </label>
                        <f:input id="type" class="form-control" path="leaveType" minlength="2" type="text" />
                      </div>
                      
                    
                      <div class="form-group">
                        <label for="days"><i style="color: #fb9678 !important">* </i>No. of Days </label>
                        <f:input id="days" class="form-control" path="leaveDays" minlength="1" type="text" />
                      </div>
                      
                      
                      <div class="form-group">
                        <label for="detail"><i style="color: #fb9678 !important">* </i>Description </label>
                        <textarea rows="5" cols="60" class="form-control" name="leaveDescription" required></textarea>
                      </div>
