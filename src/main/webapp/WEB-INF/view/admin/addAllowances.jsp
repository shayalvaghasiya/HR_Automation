	...
	ajax.onreadystatechange=function(){
		...
		if(ajax.readyState==4){
			...
			var jsn = JSON.parse(ajax.responseText);
				...
				basicsalary.value = jsn[0].basicSalary;	
				basicsalary.readOnly = true;	
		}
		
	}
	
	ajax.open("get","getAjaxSalary.html?designationId="+designationId.value,true);
	ajax.send();
  }
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post"  modelAttribute="AllowanceVO" action="insertAllowance.html">
                    <fieldset>
                      <div class="form-group">
                        <label for="desg"><i style="color: #fb9678 !important">* </i>Designation </label>
                        <f:select class="form-control" type="text" path="designationVO.id" id="designationId" onchange="loadSalary()">
