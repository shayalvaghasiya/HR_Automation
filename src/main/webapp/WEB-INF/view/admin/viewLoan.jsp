                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <c:forEach items="${loanList}" var="i" varStatus="j">
                      	  <tr>
                        		 <td>${j.count}</td>
                           		 <td>${i.designationVO.designationName}</td>
                            	 <td>${i.loanLimit}</td>
                            	 <td>${i.loanTime}</td>
                            	 <td>${i.loanInterest}</td>
                            	 <td>
                      
                       
                              <button class="btn btn-outline-primary"><a href="editLoan.html?loanId=${i.id}">EDIT</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="deleteLoan.html?loanId=${i.id}">REMOVE</a></button>
                            </td>
                        </tr>
                        </c:forEach>
                            </tbody>
