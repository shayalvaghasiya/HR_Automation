    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Paid Leaves table</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <c:forEach items="${leaveList}" var="i" varStatus="j">
                      	  <tr>
                        		 <td>${j.count}</td>
                           		 <td>${i.leaveType}</td>
                           		 <td>${i.leaveDays}</td>
                            	 ...
                            	 <td>
                              			<button class="btn btn-outline-primary"><a href="editLeave.html?leaveId=${i.id}">EDIT</a></button>
                            	</td>
                            	<td>
                              		<button class="btn btn-outline-primary"><a href="deleteLeave.html?leaveId=${i.id}">REMOVE</a></button>
                            	</td>
                        </tr>
                        </c:forEach>
                      </tbody>
