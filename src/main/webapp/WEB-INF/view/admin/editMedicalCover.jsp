        ...
        <div class="content-wrapper">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Medical Cover Details</h4>
                  
                  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                  <f:form class="cmxform" id="commentForm" method="post" modelAttribute="MedicalCoverVO" action="updateMedicalCover.html">
                    <f:hidden path="id"/>
                    <fieldset>
