                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <c:forEach items="${salaryList}" var="i" varStatus="j">
                      	  <tr>
                        		 <td>${j.count}</td>
                           		 <td>${i.designationVO.designationName}</td>
                            	 <td>${i.salaryBasicSalary}</td>
                            	 <td>
                      
                               <button class="btn btn-outline-primary"><a href="editSalary.html?salaryId=${i.id}">EDIT</a></button>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="deleteSalary.html?salaryId=${i.id}">REMOVE</a></button>
                            </td>
                        </tr>
                        </c:forEach>
                            </tbody>
