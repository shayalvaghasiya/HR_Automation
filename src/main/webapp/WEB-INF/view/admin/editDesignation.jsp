...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" method="post" action="updateDesignation" modelAttribute="designationVO">
      ...
      <%--                   <f:input id="desg" class="form-control" path=""  name="designationName" minlength="2" /> --%>
                      </div>
                      
                      <div class="form-group">
                        <label for="detail"><i style="color: #fb9678 !important">* </i>Description </label>
                        <f:textarea rows="5" cols="60" path="designationDescription" class="form-control" name="designationDescription" />
                      </div>
