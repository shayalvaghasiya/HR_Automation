...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/sadminResource/css/perfect-scrollbar.min.css">
  <!-- endinject -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Medical Cover Details</h4>
                  
                  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                  <f:form class="cmxform" id="commentForm" method="get" modelAttribute="MedicalCoverVO" action="insertMedicalCover.html">
                    <fieldset>
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="amt"><i style="color: #fb9678 !important">* </i>Amount</label>
                        <f:input id="amt" class="form-control" path="medicalcoverAmount" minlength="2" type="number" />
                      </div>
