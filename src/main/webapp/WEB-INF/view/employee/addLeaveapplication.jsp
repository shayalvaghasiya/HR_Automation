            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post"  action="insertLeaveApplication.html" modelAttribute="LeaveapplicationVO" >
                    <fieldset>
                      
                      <div class="form-group">
                        <label for="dept"><i style="color: #fb9678 !important">* </i>Leave Type </label>
                        <f:select id="dept" class="form-control"  path="leaveVO.id">
					...
					<div class="form-group">
                        <label for="fd"><i style="color: #fb9678 !important">* </i>From Date </label>
                        <f:input id="fd" class="form-control" type="date" path="fromDate" />
                      </div>
                      
                      <div class="form-group">
                        <label for="td"><i style="color: #fb9678 !important">* </i>To Date </label>
                        <f:input id="td" class="form-control" type="date" path="toDate" />
                      </div>
                      
					<div class="form-group">
                        <label for="detail"><i style="color: #fb9678 !important">* </i>Description </label>
                        <f:textarea rows="5" cols="60" class="form-control" path="leavedescription"></f:textarea>
                    </div>
