            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" id="commentForm" method="post"  action="insertComplaint.html" modelAttribute="ComplaintVO" enctype="multipart/form-data">
                    <fieldset>
                      <div class="form-group">
                        <label for="subject"><i style="color: #fb9678 !important">* </i>Complaint Subject</label>
                        <f:input id="subject" class="form-control" path="complaintSubject" minlength="2" type="text" />
                      </div>
                      <div class="form-group">
                        <label for="details"><i style="color: #fb9678 !important">* </i>Description </label>
                        <f:textarea rows="5" cols="60" class="form-control" path="complaintDescription" ></f:textarea>
                      </div>
                      ...
                      <label for="lett"><i style="color: #fb9678 !important">*</i>Upload File </label>
                        ...
                        <input id="comp" class="form-control" name="complaintFileToUpload"  type="file" required>
                      </div>
